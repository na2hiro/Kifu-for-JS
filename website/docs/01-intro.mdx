...
<video controls="controls" loop name="盤面タップで再生" width="100%" style={{maxWidth: "400px"}}>
  <source src="/img/tap-to-play.mp4" />
</video>
...
お持ちのサイト・ブログに合わせたレイアウト調整は簡単にできます。 [スタイルとレイアウト](./style-and-layout)をご覧ください。
