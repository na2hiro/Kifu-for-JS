...
var kifParser = require("../out/kif-parser.js");

function p(x, y){
	return {x:x,y:y};
}
describe("kif-parser", function(){
	it("simple", function(){
	...
	it("comment", function(){
		assert.deepEqual(kifParser.parse("*開始時コメント\n1 ７六歩(77)\n*初手コメント\n*初手コメント2\n2 ３四歩(33)\n3 ２二角成(88)\n"),{
			header:{},
			moves:[
				{comments:["開始時コメント"]},
	...
	describe("header", function(){
		it("手合割", function(){
			...
			assert.deepEqual(kifParser.parse("手合割：六枚落ち\n1 ４二玉(51)\n2 ７六歩(77)\n3 ２二銀(31)\n 4 ６六角(88)\n5 ８二銀(71)\n"),{
				header:{
					"手合割":"六枚落ち",
				},
				initial: {preset: "6"},
