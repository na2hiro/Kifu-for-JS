...
gulp.task('build', ['clean-lib'], function(cb){
	var error = false;
...
gulp.task('build-browserify', ['clean-out'], function(){
...
gulp.task('test', ['build','clean-coverage'], test);
...
gulp.watch(LIB_FILE, ['build-browserify']);
