...
const SettingsIcon = forwardRef<SVGSVGElement, Props>(({ width, height, kifuStore }, ref) => {
    ...
    return (
        <>
            <g>
                <rect fillOpacity={0} x={9} y={232} width={15} height={15} onClick={onClickIcon} />
                <foreignObject x={7} y={230} width={19} height={19}>
                    <button
                        onClick={onClickIcon}
                        style={{
                            background: "none",
                    ...
                    >
                        <svg
                            ...
                            fill="currentColor"
                            style={{ opacity: isIconShown ? 0.5 : 0, transition: "opacity 0.5s ease" }}
                        >
